const NAME_DATA = [
  ...
  },
  {
    id: 3,
    name: "TotalJobs",
    title: "Application confirmation: JavaScript Developer - Real-time trading platform! with Understanding Recruitment Ltdba, here’s a chance to save when you need to move",
    body:
